(function () {
    ...
    childrenTable.$inject = ['$log', 'childrenTableData', 'volumeCells', 'volumeStructures', 'volumeHelpers', 'visUtils', 'visTable'];

    function childrenTable($log, childrenTableData, volumeCells, volumeStructures, volumeHelpers, visUtils, visTable) {
